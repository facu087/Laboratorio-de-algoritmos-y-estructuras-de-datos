...
puntos_totales_acumulados= puntos_nuevos+puntos_totales
print (f"Has ganado {puntos_nuevos} puntos! En total, acumulas {puntos_totales_acumulados} puntos")
