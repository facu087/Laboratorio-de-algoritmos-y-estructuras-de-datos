...
if palabra1 and palabra2 in frase:
    print(f"Las palabras {palabra1} y {palabra2} estan en el texto anterior")
else:
    print(f"Las palabras {palabra1} y {palabra2} no estan en el texto anterior")
